<template>
    <div :id="'overviewmap-'+viewerId" class="overview-container">
        <!--<div v-show="showOverviewMap"></div>-->
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$parent.$refs.olmap.$createPromise.then(() => {
                this.$parent.$refs.olmap.$map.addControl(new OverviewMap({
                    // target: document.getElementById(`overviewmap-${this.id}`),
                    collapsed: false
                }));
